...
<head>
    ...
    <title>Reading Comprehension - Learning Games</title>
    <link rel="stylesheet" href="../styles/main.css">
    <link rel="stylesheet" href="../styles/reading-comprehension.css?v=1.0">
</head>
<body>
    <div class="container">
        <header class="game-header">
            ...
            <h1 class="game-title">📖 Reading Comprehension</h1>
        ...
        <main class="game-container">
            ...
            <div class="instructions-card" id="instructionsCard">
                ...
                <ul class="instructions-list">
                    ...
                    <li>Pay attention to details and main ideas</li>
                    <li>Take your time to understand the content</li>
                    <li>Earn points for correct answers!</li>
                </ul>
                <button class="start-button" onclick="startGame()">Start Reading</button>
            </div>
            ...
            <div class="game-play-area" id="gamePlayArea" style="display: none;">
                <div class="task-card" id="taskCard">
                    <div class="task-header">
                        <span class="task-type" id="taskType">Reading Comprehension</span>
                        <span class="task-number">Question <span id="taskNumber">1</span>/12</span>
                    </div>
            ...
            <div class="game-over-screen" id="gameOverScreen" style="display: none;">
                ...
                <p class="game-over-message">Congratulations! You've completed all reading passages!</p>
                ...
                <div class="final-stats">
                    <div class="final-stat">
                        ...
                        <span class="final-stat-value"><span id="questionsCompleted">0</span>/12</span>
                    </div>
                    <div class="final-stat">
    ...
    <script src="../scripts/reading-comprehension.js?v=1.0"></script>
</body>
</html>
