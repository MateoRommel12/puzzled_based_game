...
<head>
    ...
    <title>Word Scramble - Learning Games</title>
    <link rel="stylesheet" href="../styles/main.css">
    <link rel="stylesheet" href="../styles/word-scramble.css?v=1.0">
</head>
<body>
    <div class="container">
        ...
        <main class="game-container">
            ...
            <div class="instructions-card" id="instructionsCard">
                ...
                <ul class="instructions-list">
                    ...
                    <li>Click and drag letters to rearrange them</li>
                    <li>Submit your answer when you think it's correct</li>
                    <li>Earn points for correct answers and speed!</li>
                </ul>
                <button class="start-button" onclick="startGame()">Start Scrambling</button>
            </div>
            ...
            <div class="game-play-area" id="gamePlayArea" style="display: none;">
                <div class="task-card" id="taskCard">
                    <div class="task-header">
                        <span class="task-type" id="taskType">Word Scramble</span>
                        <span class="task-number">Word <span id="taskNumber">1</span>/15</span>
                    </div>
            ...
            <div class="game-over-screen" id="gameOverScreen" style="display: none;">
                ...
                <p class="game-over-message">Congratulations! You've unscrambled all the words!</p>
                ...
                <div class="final-stats">
                    <div class="final-stat">
                        <span class="final-stat-label">Correct Words</span>
                        <span class="final-stat-value"><span id="wordsCompleted">0</span>/15</span>
                    </div>
                    <div class="final-stat">
    ...
    <script src="../scripts/word-scramble.js?v=1.0"></script>
</body>
</html>
