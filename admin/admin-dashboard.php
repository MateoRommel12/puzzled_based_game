        ...
        <div id="clustering" class="tab-content">
            ...
            <div class="clustering-header">
                ...
                <div class="clustering-controls">
                    <button class="export-excel-btn" onclick="exportClusteringToExcel()">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <button class="run-clustering-btn literacy-clustering-btn" onclick="runManualClustering('literacy')">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polygon points="5,3 19,12 5,21"></polygon>
                        </svg>
                        Run Literacy Clustering
                    </button>
                    <button class="run-clustering-btn math-clustering-btn" onclick="runManualClustering('math')">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polygon points="5,3 19,12 5,21"></polygon>
                        </svg>
                        Run Math Clustering
